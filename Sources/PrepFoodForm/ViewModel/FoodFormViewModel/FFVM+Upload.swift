...
//            amount: <#T##FoodValue#>,
//            serving: <#T##FoodValue?#>,
//            nutrients: <#T##FoodNutrients#>,
//            sizes: <#T##[FoodSize]#>,
//            density: <#T##FoodDensity?#>,
//            linkUrl: <#T##String?#>,
//            prefilledUrl: <#T##String?#>,
//            imageIds: <#T##[UUID]?#>,
//            status: <#T##UserFoodStatus#>,
//            spawnedUserFoodId: <#T##UUID?#>,
//            spawnedDatabaseFoodId: <#T##UUID?#>,
//            userId: <#T##UUID#>,
//            barcodes: <#T##[FoodBarcode]#>
//        )
//    }
//
...
//            volumeExplicitUnit: <#T##VolumeExplicitUnit?#>,
//            sizeUnitId: <#T##String?#>,
//            sizeUnitVolumePrefixExplicitUnit: <#T##VolumeExplicitUnit?#>
//        )
//    }
//}
//
...
//        self.double = doubleValue.double ?? 0,
//        self.unit = unit.unitType,
//        self.weightUnit = unit.weightUnit,
