...
let mockVolumePrefixedSizes: [Size] = [
    Size(quantity: 1, quantityString: "1", volumePrefixUnit: .volume(.cup), name: "shredded", amount: 155, amountString: "155", unit: .weight(.g), fillType: .prefill()),
    Size(quantity: 1, quantityString: "1", volumePrefixUnit: .volume(.cup), name: "sliced", amount: 110, amountString: "110", unit: .weight(.g), fillType: .prefill()),
    Size(quantity: 1, quantityString: "1", volumePrefixUnit: .volume(.cup), name: "pureed", amount: 205, amountString: "205", unit: .weight(.g), fillType: .prefill()),
]
