...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/pxlshpr/FoodLabelScanner", from: "0.0.40"),
        .package(url: "https://github.com/pxlshpr/FoodLabel", from: "0.0.22"),
        ...
        .package(url: "https://github.com/pxlshpr/SwiftUISugar", from: "0.0.183"),
