...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/pxlshpr/FoodLabelScanner", from: "0.0.23"),
        ...
        .package(url: "https://github.com/pxlshpr/SwiftUISugar", from: "0.0.180"),
        .package(url: "https://github.com/pxlshpr/PrepUnits", from: "0.0.61"),
