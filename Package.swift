...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/pxlshpr/SwiftUICamera", from: "0.0.18"),
        .package(url: "https://github.com/pxlshpr/FoodLabelScanner", from: "0.0.22"),
        .package(url: "https://github.com/pxlshpr/FoodLabel", from: "0.0.17"),
        ...
        .package(url: "https://github.com/pxlshpr/ZoomableScrollView", from: "0.0.17"),
    ],
    targets: [
