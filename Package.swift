...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/pxlshpr/PrepNetworkController", from: "0.0.5"),
        .package(url: "https://github.com/pxlshpr/SwiftUICamera", from: "0.0.34"),
        .package(url: "https://github.com/pxlshpr/FoodLabelCamera", from: "0.0.16"),
        .package(url: "https://github.com/pxlshpr/FoodLabelScanner", from: "0.0.70"),
        .package(url: "https://github.com/pxlshpr/VisionSugar", from: "0.0.72"),
        .package(url: "https://github.com/pxlshpr/FoodLabel", from: "0.0.24"),
        .package(url: "https://github.com/pxlshpr/MFPScraper", from: "0.0.56"),
